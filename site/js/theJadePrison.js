...
var _user$project$TheJadePrison$abilities = {
	ctor: '::',
	_0: 'Archery',
	_1: {
		ctor: '::',
...
var _user$project$TheJadePrison$attributes = {
	ctor: '::',
	_0: 'Strength',
	_1: {
		ctor: '::',
...
var _user$project$TheJadePrison$castes = {
	ctor: '::',
	_0: 'Dawn',
	_1: {
		ctor: '::',
...
var _user$project$TheJadePrison$simpleOption = function (val) {
	return A2(
...
var _user$project$TheJadePrison$updateExAttributes = F3(
	function (attributes, exAttribute, attributeValue) {
		return A3(_elm_lang$core$Dict$insert, exAttribute, attributeValue, attributes);
	});
var _user$project$TheJadePrison$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'EditPlayerInformation') {
			var _p1 = _p0._1;
			...
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						exAttributes: A3(_user$project$TheJadePrison$updateExAttributes, model.exAttributes, _p0._0, _p0._1)
					}),
				{ctor: '[]'});
		}
	});
var _user$project$TheJadePrison$emptyExAttributes = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Manipulation', _1: 1},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'Appearance', _1: 1},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'Perception', _1: 1},
								_1: {
									ctor: '::',
...
var _user$project$TheJadePrison$emptyPlayerInfo = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'Caste',
					_1: _elm_lang$core$Maybe$Just('Dawn')
				},
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'Supernal',
								_1: _elm_lang$core$Maybe$Just('Archery')
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$TheJadePrison$Model = F2(
	function (a, b) {
		return {playerInformation: a, exAttributes: b};
	});
var _user$project$TheJadePrison$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	A2(_user$project$TheJadePrison$Model, _user$project$TheJadePrison$emptyPlayerInfo, _user$project$TheJadePrison$emptyExAttributes),
	{ctor: '[]'});
var _user$project$TheJadePrison$EditExAttribute = F2(
	function (a, b) {
		return {ctor: 'EditExAttribute', _0: a, _1: b};
	});
var _user$project$TheJadePrison$pointDot = F3(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							A2(_user$project$TheJadePrison$EditExAttribute, exAttribute, attributeValue)),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$TheJadePrison$exAttributeView = F2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						A3(
							_elm_lang$core$List$map2,
							_user$project$TheJadePrison$pointDot(exAttribute),
							A2(_elm_lang$core$List$range, 1, 5),
							filledList)),
					_1: {ctor: '[]'}
				}
...
var _user$project$TheJadePrison$physicalAttributes = function (exAttributes) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Physical'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Strength'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Dexterity'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Stamina'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$TheJadePrison$socialAttributes = function (exAttributes) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Charisma'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Manipulation'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Appearance'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$TheJadePrison$mentalAttributes = function (exAttributes) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Perception'),
				_1: {
					ctor: '::',
					_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Intelligence'),
					_1: {
						ctor: '::',
						_0: A2(_user$project$TheJadePrison$exAttributeView, exAttributes, 'Wits'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$TheJadePrison$allExAttributesView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$TheJadePrison$physicalAttributes(model.exAttributes),
							_1: {
								ctor: '::',
								_0: _user$project$TheJadePrison$socialAttributes(model.exAttributes),
								_1: {
									ctor: '::',
									_0: _user$project$TheJadePrison$mentalAttributes(model.exAttributes),
									_1: {ctor: '[]'}
								}
							}
						}),
...
var _user$project$TheJadePrison$EditPlayerInformation = F2(
	function (a, b) {
		return {ctor: 'EditPlayerInformation', _0: a, _1: b};
	});
var _user$project$TheJadePrison$casteSelect = A2(
	_elm_lang$html$Html$select,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onInput(
			_user$project$TheJadePrison$EditPlayerInformation('Caste')),
		_1: {ctor: '[]'}
	},
	A2(_elm_lang$core$List$map, _user$project$TheJadePrison$simpleOption, _user$project$TheJadePrison$castes));
var _user$project$TheJadePrison$supernalSelect = A2(
	_elm_lang$html$Html$select,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onInput(
			_user$project$TheJadePrison$EditPlayerInformation('Supernal')),
		_1: {ctor: '[]'}
	},
	A2(_elm_lang$core$List$map, _user$project$TheJadePrison$simpleOption, _user$project$TheJadePrison$abilities));
var _user$project$TheJadePrison$playerInformationView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(
							_user$project$TheJadePrison$EditPlayerInformation('Name')),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(
								_user$project$TheJadePrison$EditPlayerInformation('Player')),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
				_1: {
					ctor: '::',
					_0: _user$project$TheJadePrison$casteSelect,
					_1: {
						ctor: '::',
						_0: A2(
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(
											_user$project$TheJadePrison$EditPlayerInformation('Concept')),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(
												_user$project$TheJadePrison$EditPlayerInformation('Anima')),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
								_1: {
									ctor: '::',
									_0: _user$project$TheJadePrison$supernalSelect,
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$TheJadePrison$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$TheJadePrison$playerInformationView(model),
			_1: {
				ctor: '::',
				_0: _user$project$TheJadePrison$allExAttributesView(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$TheJadePrison$main = _elm_lang$html$Html$program(
	{
		init: _user$project$TheJadePrison$init,
		view: _user$project$TheJadePrison$view,
		update: _user$project$TheJadePrison$update,
		subscriptions: function (_p2) {
			return _elm_lang$core$Platform_Sub$none;
		}
	})();
...
var Elm = {};
Elm['TheJadePrison'] = Elm['TheJadePrison'] || {};
if (typeof _user$project$TheJadePrison$main !== 'undefined') {
    _user$project$TheJadePrison$main(Elm['TheJadePrison'], 'TheJadePrison', {"types":{"message":"TheJadePrison.Msg","aliases":{},"unions":{"TheJadePrison.Msg":{"tags":{"EditPlayerInformation":["String","String"],"EditExAttribute":["String","Int"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
